...
<body>
<div id="container">
<h1>HDF Group Benchmark Test Alert via E-mail</h1>

<?
$valid = true;
if($name == ""){
  $valid = false;
  echo("<font color=red>No name is set.</font><p>");
...
if($valid){
  $query = "INSERT INTO subscribe VALUES(NULL,'$name', '$email')";
  $result = mysql_query($query);

  if($result == 1){
  
    echo('Your e-mail address is added into mailing list.<br>');
  }
  else{
    echo('Your e-mail address is <font color=red>already in the mailing list</font>.<br>');
  }
}
mysql_close($link);
?>
