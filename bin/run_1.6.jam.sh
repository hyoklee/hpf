...
PERF_OPTION="--disable-shared --prefix=/mnt/hdf/hyoklee/chicago --with-hdf5=$HDF5_PREFIX --with-mysqlclient=/mnt/hdf/hyoklee/mysql"
...
/mnt/scr1/hyoklee/bin/git clone --quiet https://github.com/HDFGroup/hdf5.git -b hdf5_1_6 svn
cd svn
