...
$aid = $_POST["aid"];
$host = $_POST["host"];
$versions = get_hdf_versions($aid, $host);
?>
...
<fieldset>
<legend>Please select HDF library version</legend>

<form method="POST" action="4.php" name="form">
...
if(count($versions) != 0){
  ...
  /* Not yet
  if(count($versions) > 1){
    echo"<option value='all'>all versions";
  }
  */
  echo("</select></td>");
}
else{
  echo("<td><font color=red>No versions are available.</font></td>");
}
?>
</tr>
<tr>
