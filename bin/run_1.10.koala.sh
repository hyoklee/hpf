...
/scr/hyoklee/bin/git clone --quiet https://github.com/HDFGroup/hdf5.git -b hdf5_1_10 svn
# /scr/hyoklee/bin/git clone --quiet https://github.com/hyoklee/hdf5.git -b patch-5 svn
cd svn
