...
#
# Copyright (C) 2009-2017 The HDF Group, Inc. All Rights Reserved.
###############################################################################
...
PERF_OPTION="CC=$HDF5_PREFIX/bin/h5cc CXX=/usr/hdf/bin/gcc520/g++  --disable-shared --prefix=/mnt/hdf/hyoklee/chicago --with-hdf5=$HDF5_PREFIX --with-mysqlclient=/mnt/hdf/hyoklee/mysql"
...
/mnt/scr1/hyoklee/bin/git clone --quiet https://github.com/HDFGroup/hdf5.git -b hdf5_1_10 svn
# /mnt/scr1/hyoklee/bin/git clone --quiet https://github.com/hyoklee/hdf5.git -b patch-5 svn
cd svn
