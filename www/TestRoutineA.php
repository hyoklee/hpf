...
// print($content_TestRoutine);
for( $i = 0; $i< $content_TestRoutine; $i++ ) {
  // print($matches[0][$i]);
  $mat1x = explode('=',$matches[0][$i]);
  $mat1y = explode(" ",$mat1x[1]);
  echo $mat1y[0]." ".$mat1y[1]."\n";

  $mat2x = explode("'",$matches[0][$i]);
  $mat2y = explode("'",$mat2x[1]);
  echo $mat2y[0]."\n";

  $mat3x = explode("Desc",$matches[0][$i]);
  $mat3y = explode("'",$mat3x[1]);
  $mat3z = explode("'",$mat3y[1]);
  echo $mat3z[0]."\n";

  $mat4x = explode("Version",$matches[0][$i]);
