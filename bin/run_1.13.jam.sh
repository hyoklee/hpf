...
#
# Copyright (C) 2009-2019 The HDF Group, Inc. All Rights Reserved.
###############################################################################
...
/mnt/scr1/hyoklee/bin/git clone --quiet https://github.com/HDFGroup/hdf5.git -b develop svn
# /mnt/scr1/hyoklee/bin/git clone --quiet https://github.com/hyoklee/hdf5.git -b patch-4 svn
cd svn
